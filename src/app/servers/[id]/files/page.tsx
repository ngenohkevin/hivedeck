...
import { ArrowLeft, Folder, File, RefreshCw, ChevronRight } from "lucide-react";
    ...
    <div className="min-h-screen bg-background">
      <header className="sticky top-0 z-50 border-b bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
        <div className="container mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            <Button variant="outline" size="icon" onClick={() => loadFiles(currentPath)} disabled={loading}>
      ...
      <main className="container mx-auto px-4 py-6">
        ...
        {error ? (
          <div className="text-center py-12">
            ...
            <Button variant="outline" onClick={() => loadFiles(currentPath)} className="mt-4">
              Retry
            </Button>
          </div>
        ) : loading ? (
